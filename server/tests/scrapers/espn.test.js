...
const sampleResponse = {
  players: [
    {
      player: { fullName: 'Shohei Ohtani', id: 39832, defaultPositionId: 10, eligibleSlots: [11, 13, 14, 16, 17], ownership: { averageDraftPosition: 1.5 } },
      ratings: { '0': { positionalRanking: 1, totalRating: 450.5 } },
    },
    {
      player: { fullName: 'Mookie Betts', id: 33039, defaultPositionId: 6, eligibleSlots: [4, 6, 19, 10, 5, 12, 16, 17], ownership: { averageDraftPosition: 8.7 } },
      ratings: { '0': { positionalRanking: 3, totalRating: 380.2 } },
    },
    {
      player: { fullName: 'Logan Webb', id: 41278, defaultPositionId: 1, eligibleSlots: [13, 14, 16, 17], ownership: { averageDraftPosition: 45.2 } },
      ratings: { '0': { positionalRanking: 10, totalRating: 200.0 } },
    },
    {
      player: { fullName: 'Cal Raleigh', id: 41345, defaultPositionId: 2, eligibleSlots: [0, 12, 16, 17], ownership: { averageDraftPosition: 12.1 } },
